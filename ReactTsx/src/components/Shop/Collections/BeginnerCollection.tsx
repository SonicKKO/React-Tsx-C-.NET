...
function BeginnerCollection() {
  ...
  useEffect(() => {
      const fetchKendamaItems = async () => {
          try {
              const response = await axios.get('http://localhost:5156/api/Kendama/filter?category=beginner');
...
export default BeginnerCollection;
